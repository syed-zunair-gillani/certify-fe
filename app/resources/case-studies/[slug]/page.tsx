...
import ArticleDetail from '@/components/CaseStudyDetail'
import ArticleShare from '@/components/CaseStudyShare'
import ArticleSection from '@/components/ArticleSection'
import { cache } from 'react'
import type { Metadata } from 'next'
import { postsMapping } from '../../case-studies/action'
...
export const generateMetadata = async ({ params }: Props): Promise<Metadata> => {
  ...
  if (post != null) {
    const canonical = `/resources/case-studies/${post.slug}`
...
export default async function NewsDetailPage ({ params, searchParams }: Props): Promise<JSX.Element> {
  ...
  await redirectHandler(`resources/case-studies/${params.slug}`, preview)
